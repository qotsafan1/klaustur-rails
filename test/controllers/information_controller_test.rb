...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { info_en: @information.info_en, info_is: @information.info_is } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { info_en: @information.info_en, info_is: @information.info_is } }
